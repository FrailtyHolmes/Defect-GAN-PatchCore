...
class PatchCore(pl.LightningModule):
    def __init__(self, hparams):
        ...
        # reduce=True且size_average=False，返回一个batch中所有样本损失的和
    ...
    def training_epoch_end(self, outputs):
        ...
        # print("\n")
        # print(float(self.args.coreset_sampling_ratio))
        # print("\n")
        print(total_embeddings.shape[0] * float(self.args.coreset_sampling_ratio))
        selected_idx = selector.select_batch(model=self.randomprojector, already_selected=[],
                                             N=int(total_embeddings.shape[0] * float(self.args.coreset_sampling_ratio)))
    ...
    def test_epoch_end(self, outputs):
        ...
        print(pixel_auc)
        print("Total image-level AUROC score :")
